...
public class CreateTransactionAsBalance_genericUtil extends BaseClass
{
	@Test
	public void createTransactionAsBalance() throws Throwable 
	{	
		...
		tp.transaction(elib.readDataFromExcel("Student", 1, 1), elib.readDataFromExcel("Transaction", 1, 0), elib.readDataFromExcel("Transaction", 1, 1), elib.readDataFromExcel("Transaction", 1, 2));
